...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		public enum AttachmentFlags
		{
			...
			DetachFromOtherHand = 1 << 2, // This object will be detached form the other hand.
		...
		public void AttachObject( GameObject objectToAttach, AttachmentFlags flags = defaultAttachmentFlags, string attachmentPoint = "" )
		{
			...
			//Detach form the other hand if requested
			...
			{
				//Detach all the objects form the stack
		...
		//-------------------------------------------------
		// Detach this GameObject form the attached object stack of this Hand
		//
		// objectToDetach - The GameObject to detach form this Hand
		//-------------------------------------------------
		...
		private void UpdateNoSteamVRFallback()
		{
			if ( noSteamVRFallbackCamera )
			{
				...
				if ( attachedObjects.Count > 0 )
				{
					...
					// move around a fixed distance form the camera
