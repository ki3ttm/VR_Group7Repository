...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		private Vector3 ComputeToTransformProjected( Transform xForm )
		{
			...
			// Need a non-zero distance form the hand to the center of the CircularDrive
			...
			{
				Debug.LogFormat( "The collider needs to be a minimum distance away form the CircularDrive GameObject {0}", gameObject.ToString() );
				Debug.Assert( false, string.Format( "The collider needs to be a minimum distance away form the CircularDrive GameObject {0}", gameObject.ToString() ) );
			}
		...
		//-------------------------------------------------
		// Updates the LinearMapping value form the angle
		//-------------------------------------------------
